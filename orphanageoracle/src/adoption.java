...
public class adoption extends javax.swing.JFrame {
    ...
    public void table(){
        try{
            ResultSet rs=st.executeQuery("select * from ADOPTOR");
    ...
    private void bActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bActionPerformed
        // TODO add your handling code here:
        try{
            ResultSet rs=st.executeQuery("select * from ADOPTOR where regno="+Integer.parseInt(b.getText()));
            a.setModel(DbUtils.resultSetToTableModel(rs));
        }catch(Exception e){
            JOptionPane.showMessageDialog(null, e);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        try{
            st.executeUpdate("insert into adoptor values("+Integer.parseInt(b.getText())+","+Integer.parseInt(c.getText())+",'"+d.getText()+"',"+Integer.parseInt(e.getText())+")");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        try{
            st.executeUpdate("update adoptor set amount="+Integer.parseInt(e.getText())+" where regno="+Integer.parseInt(b.getText())+" and cid="+Integer.parseInt(c.getText())+" and aadno='"+d.getText()+"'");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        try{
            st.executeUpdate("delete from adoptor where regno="+Integer.parseInt(b.getText())+" and cid="+Integer.parseInt(c.getText())+" and aadno='"+d.getText()+"'");
